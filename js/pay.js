...
if (virpa == null) {
    ...
    if (am == null) {
        ...
        var upilink = "upi://pay?pn=" + vpa + "&tn=HMFPay&pa=" + vpa + "&cu=INR";
        var qr_string = "upi://pay?pn=" + vpa + "~tn=HMFPay~pa=" + vpa + "~cu=INR"
    } else {
        var amount = params.get('amount');
        var upilink = "upi://pay?pn=" + vpa + "&tn=HMFPay&pa=" + vpa + "&cu=INR" + "&am=" + amount;
        var qr_string = "upi://pay?pn=" + vpa + "~tn=HMFPay~pa=" + vpa + "~cu=INR" + "~am=" + amount;
